...
// ---------------- Circle Interactivty ---------------
	  	...
	  	function rolloverArt(){
	  		...
	  		.style('fill', function(d) { 
	  			switch (d.kind) {
		  			case "mixed" : return "#FDA7DF"
		  			case "painting" : return "#9980FA"
		  			case "graphite" : return "#D980FA"
...
// ----------------- Dots After Initial --------------------
	...
	function extra(){
		...
		// $('circle').append('<div><p>This is a new image that is dynamically-added to the page.</p><a href="http://placehold.it/500x500" title="" data-fluidbox><img src="http://placehold.it/200x200" alt="Alternate Text" title="Image Title" /></a></div>');

		// Adding fancybox beta
		// $('circle').imageLightbox();

		// var selectorF = 'circle';
		$( 'circle' ).imageLightbox(
			{
