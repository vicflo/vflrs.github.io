...
},{"jquery":2,"throttle-debounce/debounce":3,"throttle-debounce/throttle":4}],2:[function(require,module,exports){
/*!
...
$(function() {
  ...
  $('.landing-link--theater').hover(function() {
    $('.landing-image--theater').addClass('is-shown');
  }, function() {
    $('.landing-image--theater').removeClass('is-shown');
  });

  $('.landing-link--creative').hover(function() {
    $('.landing-image--creative').addClass('is-shown');
  }, function() {
    $('.landing-image--creative').removeClass('is-shown');
  });
   $('.landing-link--me').hover(function() {
    $('.landing-image--me').addClass('is-shown');
  }, function() {
    $('.landing-image--me').removeClass('is-shown');
  });
});

},{"../_modules/menu/menu":5,"fluidbox":1,"jquery":2}]},{},[6])
