 ...
 * Custom: Also includes SplitText and DrawSVG
 *
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    function d(c) {
        if (!c)
            return 0;
        c = b(c);
        var d, e, f, g, i, j, k, l = c.tagName.toLowerCase(), m = 1, n = 1;
    ...
    f = _gsScope._gsDefine.plugin({
        ...
        init: function(a, b, f, g) {
            ...
            this._addTween(this, "_offset", this._offset, -i[0], "drawSVG")),
            !0
        },
        set: function(a) {
...
var Intense = function() {
    ...
    function A(a, c) {
        ...
        q(k, d);
        var e = {
            cursor: 'url("../media/images/close_artbox.cur") 25 25, auto'
        };
        q(i, e);
        var f = {
    ...
    function J() {
        ...
        if (b.xCurr += .05 * (b.xDest - b.xCurr),
        b.yCurr += .05 * (b.yDest - b.yCurr),
        c === !0) {
            if (g += b.xCurr - g,
            b.xCurr !== f) {
      ...
      , b = _gsScope._gsDefine.plugin({
        ...
        init: function(b, c, d, e) {
            ...
            void 0 === c.value)
                ...
                !0;
            for (this._delimiter = c.delimiter || "",
            ...
            this._runBackwards && (g = this._original,
            this._original = this._text,
            this._text = g),
            "string" == typeof c.newClass && (this._newClass = c.newClass,
            this._hasClass = !0),
            "string" == typeof c.oldClass && (this._oldClass = c.oldClass,
            this._hasClass = !0),
        ...
        set: function(a) {
            ...
            var b, c, d, e = this._text.length, f = a * e + .5 | 0;
            this._hasClass ? (b = this._newClass && 0 !== f,
            c = this._oldClass && f !== e,
            d = (b ? "<span class='" + this._newClass + "'>" : "") + this._text.slice(0, f).join(this._delimiter) + (b ? "</span>" : "") + (c ? "<span class='" + this._oldClass + "'>" : "") + this._delimiter + this._original.slice(f).join(this._delimiter) + (c ? "</span>" : "")) : d = this._text.slice(0, f).join(this._delimiter) + this._delimiter + this._original.slice(f).join(this._delimiter),
            this._svg ? this._target.textContent = d : this._target.innerHTML = "&nbsp;" === this._fillChar && -1 !== d.indexOf("  ") ? d.split("  ").join("&nbsp;&nbsp;") : d
        }
    })
      , c = b.prototype;
